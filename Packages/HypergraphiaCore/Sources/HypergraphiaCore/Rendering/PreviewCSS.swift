...
public struct PreviewPalette: Sendable {
    ...
    public static let dark = PreviewPalette(
        text: "#DEDEDF",
        headingSecondary: "rgba(222, 222, 223, 0.55)",
        background: "#1E1E1E",
        accent: "#FFD60A",
        link: "#FFD60A",
        wiki: "#FFD60A",
        ...
        codeBg: "#27272D",
        codeFg: "#DEDEDF",
        codeFilenameBg: "#27272D",
        codeFilenameFg: "#9E9EA0",
        preBg: "#27272D",
        preFg: "#DEDEDF",
        ...
        calloutDefault: "#27272D",
        calloutTip: "#27272D",
        calloutImportant: "#27272D",
        calloutWarning: "rgba(255, 214, 10, 0.13)",
        calloutCaution: "rgba(255, 69, 58, 0.16)",
        calloutAbstract: "#27272D",
        calloutExample: "#27272D",
        calloutQuote: "rgba(255, 255, 255, 0.08)",
        calloutQuestion: "#27272D",
        tocBg: "#27272D",
